...
from .views import (attendance_view, task_view, leave_application_view, custom_logout_view, home_view, \
                    ...
                    create_task, task_tracker_selection, task_dashboard, daily_timesheet, )  # register
                    # redeem_page,
...
urlpatterns = [
    ...
    path('leave_application/edit/<int:pk>/', edit_leave_application_view, name='edit_leave_application'),
